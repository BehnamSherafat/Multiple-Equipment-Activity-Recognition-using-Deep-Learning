...
subplot(2,1,1);
scatter(t,label_act{2},15,'filled');
...
% set(ax2,'ytick',1:2)
% set(ax2,'ylim',[1,2])
% set(ax2,'yticklabel',{'Moving Forward/Moving Arm','Moving Backward/Moving Arm'})
% xlim([0 T_test])
...
subplot(2,1,2);
scatter(t1,filtered_sW1,15,'filled','MarkerFaceColor',[1 0 0]);
ax3 = gca;
set(ax3,'ytick',1:2)
set(ax3,'ylim',[1,2])
