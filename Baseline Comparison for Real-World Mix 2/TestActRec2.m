...
% ######################
load('Trained_Net_Eqp2_MobileNetv2.mat','Trained_Net');
% ######################
...
title('Actual Labels for CAT 924K Loader', 'FontSize', 20)
ax1 = gca;
set(ax1,'ytick',1:3)
set(ax1,'ylim',[1,3])
set(ax1,'yticklabel',{'Moving Forward','Moving Backward','Stop'},'FontSize',20)
xlim([0 T_test])
...
set(ax2,'ytick',1:3)
set(ax2,'ylim',[1,3])
set(ax2,'yticklabel',{'Moving Forward','Moving Backward','Stop'},'FontSize', 20)
xlim([0 T_test])
...
set(ax3,'ytick',1:3)
set(ax3,'ylim',[1,3])
set(ax3,'yticklabel',{'Moving Forward','Moving Backward','Stop'},'FontSize',20)
xlim([0 T_test])
title('Predicted Labels for CAT 924K Loader', 'FontSize', 20)
